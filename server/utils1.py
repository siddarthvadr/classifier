...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier('server/opencv/haarcascades/haarcascade_frontalcatface.xml')
...
if __name__ == '__main__':
    ...
    #print(classify_image(None, "server/test images/aayushi.jpg"))
    #print(classify_image(None, "server/test images/abhishek.jpg"))
    #print(classify_image(None, "server/test images/binny.jpg"))
